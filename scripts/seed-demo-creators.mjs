...
const creators = [
  ...
  {
    email: 'demo+otto@ottougc.com',
    displayName: 'Otto Creator',
    handle: 'ottocreator',
    headline: 'Tech UGC creator focused on AI apps, creator tools, and practical demos.',
    bio: 'This creator makes no-fluff tech UGC that explains why an app matters, shows the product clearly, and gives brands content they can run as organic, paid, or founder-social creative.',
    ...
    socials: [
      ['tiktok', 'https://www.tiktok.com/@ottocreator'],
      ['youtube', 'https://www.youtube.com/@ottocreator'],
    ],
